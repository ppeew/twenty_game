...
var file_user_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x08, 0x75, 0x73, 0x65, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x32, 0xc0, 0x03, 0x0a, 0x04,
...
var file_user_proto_goTypes = []interface{}{
	(*UserStateResponse)(nil),     // 0: user.UserStateResponse
	(*UpdateUserStateInfo)(nil),   // 1: user.UpdateUserStateInfo
	(*CreateUserInfo)(nil),        // 2: user.CreateUserInfo
	(*UserInfoResponse)(nil),      // 3: user.UserInfoResponse
	(*CheckPasswordInfo)(nil),     // 4: user.CheckPasswordInfo
	(*CheckPasswordResponse)(nil), // 5: user.CheckPasswordResponse
	(*UserIDInfo)(nil),            // 6: user.UserIDInfo
	(*UpdateUserInfo)(nil),        // 7: user.UpdateUserInfo
	(*UserNameInfo)(nil),          // 8: user.UserNameInfo
	(*emptypb.Empty)(nil),         // 9: google.protobuf.Empty
}
var file_user_proto_depIdxs = []int32{
	2, // 0: user.User.CreateUser:input_type -> user.CreateUserInfo
	4, // 1: user.User.CheckPassword:input_type -> user.CheckPasswordInfo
	6, // 2: user.User.GetUserByID:input_type -> user.UserIDInfo
	8, // 3: user.User.GetUserByUsername:input_type -> user.UserNameInfo
	7, // 4: user.User.UpdateUser:input_type -> user.UpdateUserInfo
	6, // 5: user.User.GetUserState:input_type -> user.UserIDInfo
	1, // 6: user.User.UpdateUserState:input_type -> user.UpdateUserStateInfo
	3, // 7: user.User.CreateUser:output_type -> user.UserInfoResponse
	...
	3, // 10: user.User.GetUserByUsername:output_type -> user.UserInfoResponse
	9, // 11: user.User.UpdateUser:output_type -> google.protobuf.Empty
	0, // 12: user.User.GetUserState:output_type -> user.UserStateResponse
	9, // 13: user.User.UpdateUserState:output_type -> google.protobuf.Empty
